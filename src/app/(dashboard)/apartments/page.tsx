...
export default function ApartmentMaintenanceTable() {
    ...
    <div className="space-y-4 p-8">
      ...
      <div className="flex space-x-4">
        <div className="flex-1">
          <Input
            type="text"
            placeholder="Search by Apartment No. or Owner Name..."
            value={searchTerm}
            ...
            <TableRow key={apartment.id}>
              ...
              <TableCell>
                <div className="flex items-center">
                  ...
                  {formatDate(apartment.purchaseDate)}
                </div>
              </TableCell>
              <TableCell>
                <div className="flex items-center">
                  <CalendarIcon className="mr-2 h-4 w-4 opacity-70" />
                  {formatDate(apartment.housewarmingDate)}
                </div>
              </TableCell>
              <TableCell>
