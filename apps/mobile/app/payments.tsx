      ...
      <ScrollView className="flex-1 p-4">
        {loading ? (
          <View className="flex-1 justify-center items-center py-20">
            ...
            <Text className="text-gray-600 mt-4">Loading payments...</Text>
          </View>
        ) : (
          <>
            <View className="mb-4">
                ...
                <View className="flex-row justify-between items-start mb-2">
                  <View className="flex-1">
                    ...
                    <Text className="text-sm text-gray-600">
                      Flat: {payment.flatId} | {payment.month}
                    </Text>
                  </View>
                  <View
          ...
          <View className="bg-white rounded-t-3xl p-6">
            ...
            <View className="mb-4">
              ...
              <View className="flex-row gap-3">
                <TouchableOpacity
                  onPress={() =>
                    setNewPayment({ ...newPayment, type: "maintenance" })
                  }
                ...
                <TouchableOpacity
                  onPress={() =>
                    setNewPayment({ ...newPayment, type: "payout" })
                  }
                  className={`flex-1 rounded-lg py-3 items-center border-2 ${
            ...
            <View className="mb-4">
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setNewPayment({ ...newPayment, residentId: text })
                }
              />
            </View>
            ...
            <View className="mb-4">
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setNewPayment({ ...newPayment, flatId: text })
                }
              />
            </View>
