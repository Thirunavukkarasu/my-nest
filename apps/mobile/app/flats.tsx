...
// Mock data - in production, use state management or API
const mockFlats: Flat[] = [
  { id: '1', floor: 1, flatNumber: '101', isOccupied: true, createdAt: '2024-01-01', updatedAt: '2024-01-01' },
  { id: '2', floor: 1, flatNumber: '102', isOccupied: false, createdAt: '2024-01-01', updatedAt: '2024-01-01' },
];
      ...
      <ScrollView className="flex-1 p-4">
        <View className="mb-4">
          <Text className="text-sm text-gray-600 mb-2">
            Total: {flats.length} flats | Occupied: {flats.filter(f => f.isOccupied).length} | Vacant: {flats.filter(f => !f.isOccupied).length}
          </Text>
        </View>
                ...
                {floorFlats.map((flat) => (
                  <View
                    ...
                    className={`w-[48%] bg-white rounded-lg p-3 mb-3 mr-2 border ${
                      flat.isOccupied ? 'border-green-300 bg-green-50' : 'border-gray-200'
                    }`}
                  >
                    <View className="flex-row justify-between items-start mb-2">
                      <Text className="text-lg font-semibold text-gray-900">{flat.flatNumber}</Text>
      ...
      >
        <View className="flex-1 bg-black/50 justify-end">
          <View className="bg-white rounded-t-3xl p-6">
            ...
            <View className="mb-4">
              <Text className="text-sm font-medium text-gray-700 mb-2">Floor (1-5)</Text>
              <TextInput
            ...
            <View className="mb-6">
              ...
              <TextInput
                ...
                onChangeText={(text) => setNewFlat({ ...newFlat, flatNumber: text })}
              />
            </View>
