  ...
  const loadResidents = async () => {
    try {
      ...
      const response = await apiClient.getResidents({
        page: 1,
        limit: 100, // Get all residents for now
            ...
            <ScrollView>
              ...
              <View className="mb-4">
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setNewResident({ ...newResident, phone: text })
                  }
              ...
              <View className="mb-4">
                ...
                <View className="flex-row gap-3">
                  <TouchableOpacity
                    onPress={() =>
                      setNewResident({ ...newResident, type: "owner" })
                    }
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      setNewResident({ ...newResident, type: "tenant" })
                    }
                    className={`flex-1 rounded-lg py-3 items-center border-2 ${
              ...
              <View className="mb-6">
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setNewResident({ ...newResident, flatId: text })
                  }
                />
              </View>
